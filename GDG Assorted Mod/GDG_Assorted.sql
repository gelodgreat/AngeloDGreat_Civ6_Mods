...
UPDATE GlobalParameters SET Value=2 WHERE Name='CITY_AMENITIES_FOR_FREE'; -- City Amenities default = 1
UPDATE GlobalParameters SET Value=10 WHERE Name='CITY_MAX_BUY_PLOT_RANGE'; -- Buying City plot range default = 3
