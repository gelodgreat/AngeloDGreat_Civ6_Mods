-- UPDATE Governments SET OtherGovernmentIntolerance = -0.1;
...
-- DELETE FROM Governments WHERE OtherGovernmentIntolerance=--0.1 AND GovernmentType='GOVERNMENT_CLASSICAL_REPUBLIC'
