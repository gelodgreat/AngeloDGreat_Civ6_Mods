...
-- MODIFIER ARGUMENTS
INSERT INTO ModifierArguments (ModifierId,Name,Value) VALUES ('TRAIT_FASTER_BORDER_GROWTH','Amount',200);	
...
INSERT INTO ModifierArguments (ModifierId,Name,Value) VALUES ('TRAIT_CIVILIZATION_GDG_FASTEST_SETTLER_PROD','Amount',200);	
--NEW EXTRA WILD CARD
...
--NEW WONDER PRODUCTION
INSERT INTO ModifierArguments (ModifierId,Name,Value) VALUES ('TRAIT_CIVILIZATION_GDG_WONDER_PRODUCTION','Amount',200);
--NEW District PRODUCTION
INSERT INTO ModifierArguments (ModifierId,Name,Value) VALUES ('TRAIT_CIVILIZATION_GDG_DISTRICT_PRODUCTION','Amount',200);	
-- Discount Unit Upgrade
INSERT INTO ModifierArguments (ModifierId,Name,Value) VALUES ('TRAIT_CIVILIZATION_GDG_UNIT_UPGRADE_DISCOUNT','Amount',200);
--City Growth Rate
...
-- Discount Unit Upgrade	
INSERT INTO TraitModifiers (TraitType,ModifierId) VALUES ('TRAIT_GDG_CIVILIZATION_UNIT_UPGRADE_DISCOUNT','TRAIT_CIVILIZATION_GDG_BUILDING_PRODUCTION');	
--City Growth Rate	
