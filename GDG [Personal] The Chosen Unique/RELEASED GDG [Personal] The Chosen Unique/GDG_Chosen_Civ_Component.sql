...
--Moar Mods Compatibility (just uncomment what civ you're using)
	INSERT INTO CivilizationTraits (CivilizationType,TraitType) VALUES 
		...
		('CIVILIZATION_AUSTRALIA' ,'TRAIT_CIVILIZATION_UNIT_GENDARME'),
		('CIVILIZATION_AUSTRALIA' ,'TRAIT_CIVILIZATION_UNIT_FRENCH_MARINE');
...
-- DELETE FROM CivilizationTraits WHERE CivilizationType='CIVILIZATION_AUSTRALIA' AND TraitType='TRAIT_CIVILIZATION_BUILDING_ELECTRONICS_FACTORY';
