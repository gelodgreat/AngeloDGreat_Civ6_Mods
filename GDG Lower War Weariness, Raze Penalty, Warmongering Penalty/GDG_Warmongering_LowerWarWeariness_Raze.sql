...
-- DEFAULT = 10
UPDATE GlobalParameters SET Value=0 WHERE Name='WAR_WEARINESS_PER_WMD_LAUNCHED';
-- DEFAULT = 2
UPDATE GlobalParameters SET Value=0 WHERE Name='WAR_WEARINESS_LOSS_OVER_REQ_AMENITIES_AT_WAR_CITY';
-- DEFAULT = 16
UPDATE GlobalParameters SET Value=4 WHERE Name='WAR_WEARINESS_WARMONGER_BASE';
-- DEFAULT = 2000
